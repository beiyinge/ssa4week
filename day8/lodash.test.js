...
describe('Easy - needs a single lodash function, with optional scalar arguments', function () {
  it('#1', function () {
    ...
    var actual = _.takeRight(input, 3);   // <----- Edit this line
  ...
  it('#2', function () {
    ...
    var actual = _.concat(input1, input2);   // <----- Edit this line
    actual.must.eql(expected);
  });
  ...
  it('#3', function () {
    ...
    var input2 = 0;
    var expected = 4;
    var actual = _.indexOf(input1, input2);   // <----- Edit this line
    actual.must.eql(expected);
  });
  ...
  it('#4', function () {
    ...
    var actual = _.last(input);   // <----- Edit this line
    actual.must.eql(expected);
  });
  ...
  it('#5', function () {
    ...
    var actual = _.take(input,3);   // <----- Edit this line
    actual.must.eql(expected);
  });
